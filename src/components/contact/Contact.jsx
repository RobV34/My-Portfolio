...
//                 <p>LinkedIn: <a href="https://linkedin.com/in/robvatcher" target="_blank" rel="noopener noreferrer">Rob Vatcher</a></p>
...
function Contact() {
    return (
        <div className="contact-container">
            <h2>Contact Me</h2>
            <div className="contact-info">
                <p>Email: <a href="mailto:rcvatcher@gmail.com">rcvatcher@gmail.com</a></p>
                <p>Phone: <a href="tel:7096934734">709-693-4734</a></p>
                <p>Website: <a href="http://robsportfolio.com" target="_blank" rel="noopener noreferrer">robsportfolio.com</a></p>
                <p>LinkedIn: <a href="https://linkedin.com/in/robvatcher" target="_blank" rel="noopener noreferrer">Rob Vatcher</a></p>
                <p>GitHub: <a href="https://github.com/RobV34" target="_blank" rel="noopener noreferrer">My Projects</a></p>
            </div>
